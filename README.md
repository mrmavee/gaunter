...
```bash
# Example for v1.0.0
wget https://git.mrmave.work/maverick/gaunter/releases/download/v1.0.0/gaunter-v1.0.0-linux-amd64
wget https://git.mrmave.work/maverick/gaunter/releases/download/v1.0.0/gaunter-v1.0.0-linux-amd64.sha256
wget https://git.mrmave.work/maverick/gaunter/releases/download/v1.0.0/gaunter-v1.0.0-linux-amd64.asc
...
sha256sum -c gaunter-v1.0.0-linux-amd64.sha256
gpg --verify gaunter-v1.0.0-linux-amd64.asc gaunter-v1.0.0-linux-amd64
```
